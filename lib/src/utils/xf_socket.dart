...
import '../bean/xf_res.dart';
import '../bean/xf_text_req.dart';
import '../bean/xf_voice_req.dart';
import '../bean/xf_voice_res.dart';
...
class XfSocket {
  ...
  isClose() {
    ...
    return _channel?.closeCode == status.goingAway;
  }
